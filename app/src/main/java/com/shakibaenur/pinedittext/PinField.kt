...
open class PinField : AppCompatEditText {
    ...
    var isCursorEnabled = false
     ...
     var yPadding = Utils.dpToPx(10f)

     var highlightSingleFieldType = HighlightType.ALL_FIELDS
    ...
    private fun initParams(attr: AttributeSet) {
        ...
        try {
            ...
            fieldColor = a.getColor(R.styleable.PinField_strokeColor, fieldColor)
            highlightPaintColor =
    ...
    fun highlightNextField(): Boolean {
